              ...
              >
                <table className="w-full text-left border-collapse">
                  <thead className="bg-accent/10 border-b-2 border-black">
                    <tr>
                      <th className="p-6 font-hand text-2xl">Title</th>
                      <th className="p-6 font-hand text-2xl">Status</th>
                      <th className="p-6 font-hand text-2xl">Tags</th>
                      <th className="p-6 font-hand text-2xl">Last Active</th>
                    </tr>
                  </thead>
                  <tbody>
                    {filteredPosts.map(post => (
